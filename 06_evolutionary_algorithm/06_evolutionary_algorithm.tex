...
\only<21>{\listing{0.9}{1.4}{language=myJava}{code/EAnoCR_21.java}}%
\only<22>{\listing{0.9}{1.4}{language=myJava}{code/EAnoCR_22.java}}%
\only<23>{\listing{0.9}{1.4}{language=myJava}{code/EAnoCR.java}}%
\end{frame}%
%
...
\only<1>{\listing{0.9}{1.7}{language=myJava}{code/EANoCR.java}}%
\only<2>{\listing{0.9}{1.7}{language=myJava}{code/EAWithCR_1.java}}%
\only<3>{\listing{0.9}{1.7}{language=myJava}{code/EAWithCR_2.java}}%
\only<4>{\listing{0.9}{1.7}{language=myJava}{code/EAWithCR_3.java}}%
\only<5>{\listing{0.9}{1.7}{language=myJava}{code/EAWithCR_4.java}}%
\only<6>{\listing{0.9}{1.7}{language=myJava}{code/EAWithCR.java}}%
\end{frame}%
%
\begin{frame}%
...
\only<2,31>{\listing{0.9}{1.76}{language=myJava}{code/EAWithClearing.java}}%
...
\only<28>{\listing{0.9}{1.76}{language=myJava}{code/EAWithClearing_26.java}}%
\only<29>{\listing{0.9}{1.76}{language=myJava}{code/EAWithClearing_27.java}}%
\only<30>{\listing{0.9}{1.76}{language=myJava}{code/EAWithClearing_28.java}}%
\end{frame}%
%
\section{Experiment and Analysis}%
%
