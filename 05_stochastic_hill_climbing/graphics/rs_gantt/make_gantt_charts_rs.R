...
files <- c("rs_abz7_0x4d76e0390b366999.txt",
           "rs_la24_0x9c1440c4792d2a02.txt",
...
for(i in seq_along(files)) {
  ...
  data <- aitoa.load.result.from.log.file(file.path("../../../04_random_sampling/graphics/rs_gantt", file));
