...
%
\begin{frame}[t]%
\frametitle{Instance \instStyle{abz7}}%
Instance \instStyle{abz7} by Adams et~al.\cite{ABZ1988TSBPFJSS}%
\locateGraphic{}{width=0.95\paperwidth}{graphics/instance/abz7}{0.02}{0.25}%
\end{frame}%
%
\begin{frame}[t]%
\frametitle{Instance \instStyle{la24}}%
Instance \instStyle{la24} by Lawrence\cite{L1998RCPSAEIOHSTS}.%
\locateGraphic{}{width=0.9\paperwidth}{graphics/instance/la24}{0.05}{0.275}%
\end{frame}%
%
\begin{frame}[t]%
\frametitle{Instance \instStyle{swv15}}%
Instance \instStyle{swv15} by Storer et~al.\cite{SWV1992NSSFSPWATJSS}%
\locateGraphic{}{width=0.45\paperwidth}{graphics/instance/swv15}{0.4}{0.2}%
\end{frame}%
%
\begin{frame}[t]%
\frametitle{Instance \instStyle{yn4}}%
Instance \instStyle{yn4} by Yamada and Nakano\cite{YN1992AGAATLSJSI}.%
...
\begin{center}
\medskip%
\only<-5>{\large{one possible solution for the \instStyle{demo} instance}, illustrated as Gantt chart}%
\only<6>{\large{one possible solution for the \instStyle{la24} instance}, illustrated as Gantt chart}%
\only<7>{\large{one possible solution for the \instStyle{yn4} instance}, illustrated as Gantt chart}%
\only<8->{\large{one possible solution for the \instStyle{swv15} instance}, illustrated as Gantt chart}%
\end{center}%
}%
...
\centering%
\listing{0.85}{0.75}{language=myJava,mathescape=false}{code/IObjectiveFunction.java}%
\end{frame}%
%
\begin{frame}%
\frametitle{The JSSP Objective Function in Java}%
\centering%
\only<1>{\listing{0.85}{0.95}{language=myJava,mathescape=false}{code/JSSPMakespanObjectiveFunction_1.java}}%
\only<2>{\listing{0.85}{0.95}{language=myJava,mathescape=false}{code/JSSPMakespanObjectiveFunction_2.java}}%
\only<3>{\listing{0.85}{0.95}{language=myJava,mathescape=false}{code/JSSPMakespanObjectiveFunction_3.java}}%
\only<4>{\listing{0.85}{0.95}{language=myJava,mathescape=false}{code/JSSPMakespanObjectiveFunction_4.java}}%
\only<5>{\listing{0.85}{0.95}{language=myJava,mathescape=false}{code/JSSPMakespanObjectiveFunction_5.java}}%
\only<6>{\listing{0.85}{0.95}{language=myJava,mathescape=false}{code/JSSPMakespanObjectiveFunction_6.java}}%
\only<7>{\listing{0.85}{0.95}{language=myJava,mathescape=false}{code/JSSPMakespanObjectiveFunction_7.java}}%
\only<8>{\listing{0.85}{0.95}{language=myJava,mathescape=false}{code/JSSPMakespanObjectiveFunction.java}}%
\end{frame}%
%
\begin{frame}%
...
\only<1>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_01.java}}%
\only<2>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_02.java}}%
\only<3>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_03.java}}%
\only<4>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_04.java}}%
\only<5>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_05.java}}%
\only<6>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_06.java}}%
\only<7>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_07.java}}%
\only<8>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_08.java}}%
\only<9>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_09.java}}%
\only<10>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_10.java}}%
\only<11>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_11.java}}%
\only<12>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_12.java}}%
\only<13>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_13.java}}%
\only<14>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_14.java}}%
\only<15>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping_15.java}}%
\only<16>{\listing{0.92}{1.33}{language=myJava,mathescape=false}{code/JSSPRepresentationMapping.java}}%
\end{frame}%
%
...
&4&3&1'630&13'824\\%
&4&4&7'451&331'776\\%
\uncover<15->{\instStyle{demo}&4&5&&7'962'624\\%
\instStyle{la24}&15&10&&$\approx$~1.462*10\textsuperscript{121}\\%
\instStyle{abz7}&20&15&&$\approx$~6.193*10\textsuperscript{275}\\%
\instStyle{yn4}&20&20&&$\approx$~5.278*10\textsuperscript{367}\\%
\instStyle{swv15}&50&10&&$\approx$~6.772*10\textsuperscript{644}\\%
\hline%
}}}}}}%
\end{tabular}}%
}{0.175}{0.124}%
...
\instStyle{demo}&4&5&7'962'624&11'732'745'024\\%
\instStyle{la24}&15&10&$\approx$~1.462*10\textsuperscript{121}&$\approx$~2.293*10\textsuperscript{164}\\%
\instStyle{abz7}&20&15&$\approx$~6.193*10\textsuperscript{275}&$\approx$~1.432*10\textsuperscript{372}\\%
\instStyle{yn4}&20&20&$\approx$~5.278*10\textsuperscript{367}&$\approx$~1.213*10\textsuperscript{501}\\%
\instStyle{swv15}&50&10&$\approx$~6.772*10\textsuperscript{644}&$\approx$~1.254*10\textsuperscript{806}\\%
\hline%
\end{tabular}}%
}{0.175}{0.18}%
%
