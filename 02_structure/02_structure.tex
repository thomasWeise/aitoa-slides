...
\end{itemize}%
\uncover<2->{%
\listing{0.85}{0.95}{language=myJava}{code/JSSPInstance.java}%
}%
\end{frame}
%
%
...
\end{itemize}%
\uncover<2-3>{%
\listing{0.85}{0.95}{language=myJava}{code/JSSPCandidateSolution.java}%
}%
}%
%
...
\centering%
\listing{0.85}{0.75}{language=myJava}{code/IObjectiveFunction.java}%
\end{frame}%
%
\begin{frame}%
\frametitle{The JSSP Objective Function in Java}%
\centering%
\only<1>{\listing{0.85}{0.95}{language=myJava}{code/JSSPMakespanObjectiveFunction_1.java}}%
\only<2>{\listing{0.85}{0.95}{language=myJava}{code/JSSPMakespanObjectiveFunction_2.java}}%
\only<3>{\listing{0.85}{0.95}{language=myJava}{code/JSSPMakespanObjectiveFunction_3.java}}%
\only<4>{\listing{0.85}{0.95}{language=myJava}{code/JSSPMakespanObjectiveFunction_4.java}}%
\only<5>{\listing{0.85}{0.95}{language=myJava}{code/JSSPMakespanObjectiveFunction_5.java}}%
\only<6>{\listing{0.85}{0.95}{language=myJava}{code/JSSPMakespanObjectiveFunction_6.java}}%
\only<7>{\listing{0.85}{0.95}{language=myJava}{code/JSSPMakespanObjectiveFunction_7.java}}%
\only<8>{\listing{0.85}{0.95}{language=myJava}{code/JSSPMakespanObjectiveFunction.java}}%
\end{frame}%
%
\begin{frame}%
...
\listing{0.92}{0.76}{language=myJava}{code/IRepresentationMapping.java}%
\end{frame}%
%
\begin{frame}%
\frametitle{The JSSP Representation Mapping in Java}%
\only<1>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_01.java}}%
\only<2>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_02.java}}%
\only<3>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_03.java}}%
\only<4>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_04.java}}%
\only<5>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_05.java}}%
\only<6>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_06.java}}%
\only<7>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_07.java}}%
\only<8>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_08.java}}%
\only<9>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_09.java}}%
\only<10>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_10.java}}%
\only<11>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_11.java}}%
\only<12>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_12.java}}%
\only<13>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_13.java}}%
\only<14>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_14.java}}%
\only<15>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping_15.java}}%
\only<16>{\listing{0.92}{1.33}{language=myJava}{code/JSSPRepresentationMapping.java}}%
\end{frame}%
%
...
%
\only<5>{\listing{0.9}{0.95}{language=myJava}{code/INullarySearchOperator.java}}%
\only<7>{\listing{0.9}{0.95}{language=myJava}{code/IUnarySearchOperator.java}}%
\only<9>{\listing{0.9}{0.95}{language=myJava}{code/IBinarySearchOperator.java}}%
%
\end{frame}%
%
%
