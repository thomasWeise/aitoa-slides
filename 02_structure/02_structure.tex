...
\item<3-> A Gantt chart $\solspel_{1}\in\solutionSpace$ is a better solution to our problem than another chart $\solspel_{2}\in\solutionSpace$ if \textcolor<12>{red}{it allows us to complete our work faster}.%
...
\item<11-> This objective function is subject to minimization: smaller values are better.%
\item<14-> \alert{A Gantt chart $\solspel_{1}\in\solutionSpace$ is a better solution to our problem than another chart $\solspel_{2}\in\solutionSpace$ if \textcolor<12>{red}{$\objf(\solspel_{1})<\objf(\solspel_{2})$}.}%
\end{itemize}%
}%
%
\end{frame}%
