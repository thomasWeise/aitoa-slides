...
\listing{0.9}{0.95}{language=myJava,mathescape=false,escapechar=\%}{code/JSSPNullaryOperator.java}%
\end{frame}%
%
\begin{frame}%
\frametitle{Implementation: Single Random Sampling Algorithm}%
\listing{0.9}{0.95}{language=myJava,mathescape=false}{code/SingleRandomSample.java}%
\end{frame}%
%
...
\hline%
\texttt{abz7}&1'131&1'334&1'326&\textcolor<11>{red}{106}&\textcolor<10>{blue}{0s}&1\\%
\texttt{la24}&1'487&1'842&1'814&\textcolor<11>{red}{165}&\textcolor<10>{blue}{0s}&1\\%
\texttt{swv15}&5'935&6'600&6'563&\textcolor<11>{red}{346}&\textcolor<10>{blue}{0s}&1\\%
\texttt{yn4}&1'754&2'036&2'039&\textcolor<11>{red}{125}&\textcolor<10>{blue}{0s}&1\\%
\hline%
\end{tabular}%
\end{center}%
}%
...
\listing{0.9}{0.95}{language=myJava,mathescape=false}{code/RandomSampling.java}%
\end{frame}%
%
...
%
\begin{center}%
\only<3,5,7,9>{\texttt{1rs}: median result of single random sample algorithm}%
\only<4,6,8,10>{\texttt{rs}: median result of 3~min of random sampling algorithm}%
\end{center}%
%
\only<-2>{%
\begin{itemize}%
...
\hline%
%
\texttt{abz7}&\texttt{1rs}&1131&1334&1326&106&0s&1\\%
&\texttt{rs}&\textcolor{green}{\textbf{895}}&\textcolor{green}{\textbf{945}}&\textcolor{green}{\textbf{948}}&\textcolor{green}{\textbf{12}}&77s&8'246'019\\%
\hline%
\texttt{la24}&\texttt{1rs}&1487&1842&1814&165&0s&1\\%
&\texttt{rs}&\textcolor{green}{\textbf{1154}}&\textcolor{green}{\textbf{1206}}&\textcolor{green}{\textbf{1207}}&\textcolor{green}{\textbf{15}}&81s&17'287'329\\%
\hline%
\texttt{swv15}&\texttt{1rs}&5935&6600&6563&346&0s&1\\%
&\texttt{rs}&\textcolor{green}{\textbf{4988}}&\textcolor{green}{\textbf{5165}}&\textcolor{green}{\textbf{5174}}&\textcolor{green}{\textbf{49}}&85s&5'525'082\\%
\hline%
\texttt{yn4}&\texttt{1rs}&1754&2036&2039&125&0s&1\\%
&\texttt{rs}&\textcolor{green}{\textbf{1459}}&\textcolor{green}{\textbf{1496}}&\textcolor{green}{\textbf{1498}}&\textcolor{green}{\textbf{15}}&83s&6'549'694\\%
%
\hline%
\end{tabular}%
}%
